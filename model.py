...
def generator(inputdim = 100, xdim = 8, ydim = 8):
    ...
    model.add(Reshape( (128, xdim, ydim), input_shape=(inputdim,) ) )
...
def discriminator():
    model = Sequential()
    model.add(Convolution2D(1024, 5, 5, subsample=(2, 2), input_shape=(3, 128, 128), border_mode = 'same'))
